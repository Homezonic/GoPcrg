            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  Welcome to {siteName}! These terms and conditions outline the rules and regulations for the use of {siteName}.dev.
                  By accessing this website we assume you accept these terms and conditions. Do not continue to use
                  {siteName}.dev if you do not agree to all of the terms and conditions stated on this page.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1">
                  Other than the content you own, under these Terms, {siteName} and/or its licensors own all the intellectual
                ...
                <Typography variant="body1">
                  This Website is provided “as is,” with all faults, and {siteName} expresses no representations or
                  warranties.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  In no event shall {siteName}, nor any of its officers, directors and employees, be held liable for anything
                ...
                <Typography variant="body1">
                  You hereby indemnify to the fullest extent {siteName} from and against any and all liabilities, costs,
                ...
                <Typography variant="body1">
                  {siteName} is permitted to revise these Terms at any time as it sees fit.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms constitute the entire agreement between {siteName} and you.
                </Typography>
                <br />
